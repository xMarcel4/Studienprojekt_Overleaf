...
\input{Other/Abbreviations}
\cleardoublepage

\input{Other/Abstract} % ben\"{o}tigt Abstract.tex
...
\input{1) Introduction/1_Introduction}
\input{2) Theory/2_0_Theory_main}
\input{3) Implementation/3_Implementation}
\input{4) Future Work}
\input{5) Conclusion}
