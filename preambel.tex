...
% Define a new command for bold vectors
...
\usepackage{listings}
\usepackage{xcolor}
\definecolor{myCustomColor}{RGB}{44,162,95}  % This is an orange-like color
\definecolor{myCustomPurple}{RGB}{84,39,136}  % This is an orange-like color


\lstset{
    language=Python,                 % Use Python as the base language (can be any language)
    basicstyle=\ttfamily\footnotesize, % Set basic font
    commentstyle=\color{myCustomColor}\ttfamily,  % Set custom RGB color for comments
    keywordstyle=[1]\color{red},      % Set style for first set of keywords
    keywordstyle=[2]\color{red},       % Set style for second set of keywords
    keywordstyle=[3]\color{blue},       % Set style for second set of keywords
    keywordstyle=[4]\color{orange},       % Set style for second set of keywords
    keywords=[1]{def, return, if, else, while, for, in, break}, % First set of keywords
    keywords=[2]{int, float, str, list, dict},     % Second set of keywords
    keywords=[3]{add_sphere,add_plane_with_hole,in_sphere},     % Second set of keywords
    keywords=[4]{range},     % Second set of keywords
    morestring=[b]',                  % Handle strings enclosed in single quotes
    morecomment=[l]{//},              % Line comments (Python uses #, modify as needed)
